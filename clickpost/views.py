...
class NotificationView(viewsets.GenericViewSet):
    ...
    def send_notification(self, request):
        ...
        if not user_id or not status or not shipment_id or not notification_type:
            return Response({'success': False, 'message': 'user id or status or shipment id  or notification_type is missing'})
        ...
        try:
            ...
            SendMessages.send_notification_message(user_id, status)
